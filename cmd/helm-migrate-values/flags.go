...
func addChartPathOptionsFlags(f *pflag.FlagSet, c *action.ChartPathOptions) {
	...
	f.StringVar(&c.CertFile, "cert-file", "", "identify HTTPS installAction using this SSL certificate file")
	f.StringVar(&c.KeyFile, "key-file", "", "identify HTTPS installAction using this SSL key file")
